...
vipind <- getSymbols("VIPIND.NS", from = "2020-04-01", to = "2024-03-31", periodicity = "monthly", auto.assign = FALSE)
visakaind <- getSymbols("VISAKAIND.NS", from ="2020-04-01", to = "2024-03-31", periodicity = "monthly", auto.assign = FALSE) 
vishnu <- getSymbols("VISHNU.NS", from ="2020-04-01", to = "2024-03-31", periodicity = "monthly", auto.assign = FALSE) 
